...
JOIN countrylanguages ON cities.country_code =  countrylanguages.country_code;
...
SELECT country_code, MAX(celebrities.age), MIN(celebrities.age)
FROM celebrities
...
SELECT '1991年' AS '誕生年', COUNT(*) AS '人数'
FROM celebrities
...
SELECT countries.name AS '国名', AVG(age) AS '平均年齢'
FROM countries
